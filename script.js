...
function contineuTheGame() {
    ...
    const desireAlphabetSmall = document.getElementById("desire-alphabet-smal-device")
    desireAlphabetSmall.innerText = alphabet;
    setColorOfAlphabet(alphabet)
...
function theElimentId(elementId) {
    const theElementValue = document.getElementById(elementId);
    const theElementText = theElementValue.innerText;
    return theElementText;
}
function gameOver() {
    endGame("end-game")
    ...
    const desireElement = theElimentId("desire-alphabet")
    removeColorOfAlphabet(desireElement)
}
